...
const Contact: React.FC<ContactProps> = ({ mode, themeColors }) => {
  ...
  return (
    <section id="contact" className="py-12 sm:py-24 px-6 overflow-hidden relative scroll-mt-20">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="space-y-6 sm:space-y-8">
            <motion.h3 variants={itemVariants} className="text-4xl sm:text-7xl font-display font-extrabold leading-tight">
              Let's <br /> 
              <motion.span 
            ...
            <motion.p variants={itemVariants} className="text-base sm:text-xl opacity-70 max-w-md leading-relaxed">
              Whether you need a sleek design or a high-performance build, I'm here to bring your vision to life.
            </motion.p>
            ...
            <motion.div variants={itemVariants} className="pt-4 sm:pt-8 flex flex-col space-y-1 sm:space-y-2">
              <span className="text-[10px] uppercase font-black tracking-widest opacity-40">General Enquiries</span>
              <a 
          ...
          >
            <form className="space-y-6 sm:space-y-8" onSubmit={(e) => e.preventDefault()}>
              <div className="space-y-1 group">
                <label className="text-[10px] uppercase font-black tracking-[0.2em] opacity-40">Name</label>
                <input 
                  type="text" 
              ...
              <div className="space-y-1 group">
                <label className="text-[10px] uppercase font-black tracking-[0.2em] opacity-40">Email</label>
                <input 
                  type="email" 
              ...
              <div className="space-y-1 group">
                <label className="text-[10px] uppercase font-black tracking-[0.2em] opacity-40">Message</label>
                <textarea 
                  rows={3} 
